...
public class SplashScreen extends JPanel 
{
  ...
  public void theSplashScreen(Graphics g)
  {
	...
	if (x >= 1680 && x <1780)
	{
	  ...
	  g.drawString("Loading" + (x-1679) + "%", 270, 460);
	  animate(2);
	}
	if (x >= 1680 && x < 1694)
	    {
	      Image cookie1 = new ImageIcon ("cookie1box.jpg").getImage();
	      g.drawImage(cookie1, 300, 230,this);     
	      animate(100);
	    }
//          else if (x >= 1694 && x < 1708)
//          {
//            Image cookie2= new ImageIcon ("MainMenuBackgroundBlue.jpg").getImage();
//            g.drawImage(cookie2, 0, 0,this);      
//            animate(100);
//          }
//          else if (x >= 1708 && x < 1722)
//          {
//            Image cookie3 = new ImageIcon ("MainMenuBackgroundBlue.jpg").getImage();
//            g.drawImage(cookie3, 0, 0,this); 
//            animate(100);
//          }
//          else if (x >= 1722 && x < 1736)
//          {
//            Image cookie4= new ImageIcon ("MainMenuBackgroundBlue.jpg").getImage();
//            g.drawImage(cookie4, 0, 0,this);     
//            animate(100);
//          }       
//          else if (x >= 1736 && x < 1750)
//          {
//            Image cookie5 = new ImageIcon ("MainMenuBackgroundBlue.jpg").getImage();
//            g.drawImage(cookie5, 0, 0,this);    
//            animate(100);
//          }
//          else if (x >= 1750 && x < 1764)
//          {
//            Image cookie6= new ImageIcon ("MainMenuBackgroundBlue.jpg").getImage();
//            g.drawImage(cookie6, 0, 0,this);     
//            animate(100);
//          }   
//          else
//            if (x >= 1764 && x < 1780)
//          {
//            Image cookie7 = new ImageIcon ("MainMenuBackgroundBlue.jpg").getImage();
//            g.drawImage(cookie7, 0, 0,this);        
//            animate(100);
//          }
      }
    }
